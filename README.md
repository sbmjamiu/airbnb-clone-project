...
- **Backend:** Node.js/Python (Flask/Django) — to be finalized
...
- Maintain a clean and modular codebase using best practices

### 3. Backend Developers
- Design and implement RESTful APIs
- Manage database schema and interactions
- Handle authentication, data validation, and business logic
- Ensure security and scalability of the backend systems

### 4. Designers
- Create high-fidelity mockups and interactive prototypes in Figma
- Define visual styles, typography, and color schemes
- Ensure UI/UX consistency and quality across all pages
- Collaborate with developers for design handoff and feedback

### 5. QA/Testers
- Write and execute test cases (unit, integration, and end-to-end)
- Identify and document bugs and usability issues
- Ensure the product meets functional and design specifications
- Work closely with devs to verify fixes and conduct regression testing

### 6. DevOps Engineers
- Set up and maintain CI/CD pipelines
- Manage server environments and cloud deployment
- Ensure uptime, monitoring, and rollback procedures are in place
- Optimize performance and automate development workflows

### 7. Product Owner
- Define user requirements and project scope
- Prioritize feature development based on business value
- Serve as a liaison between stakeholders and the dev team
- Review deliverables to ensure alignment with project goals
...
- Help manage task assignments and sprint backlogs
